...
public class CliqueConsensusMessageHandler extends Thread {
                ...
                try {
                    ...
                    if (!this.synchronizer.consensusReached.get(blockhash)) {
                        ...
                        if (this.blockchain.isValidBlock(inblock)) {
                            ...
                            // } else {
                            // this.blockchain.handleFork(inblock.getBlockNumber(), inblock.getWeight(),
                            // inblock);
                            // }
                    ...
                    // TODO Auto-generated catch block
                    System.out.println("Consens" + e1.toString());
                    e1.printStackTrace();
                }
            }
        }
    ...
    public CliqueConsensusMessageHandler(BlockingQueue<JSONObject> inMessageBlockingQueue, Blockchain blockChain,
