...
public class P2PHandler extends Thread {
    ...
    public void run() {
        ...
        CliqueMessageHandler ibftMessageHandler = new CliqueMessageHandler(this.blockchain, this.transactionPool,
                this.wallet, this.pbftMessagePool, this.validator, this.nonValidator, this.nodeCommunicator,
