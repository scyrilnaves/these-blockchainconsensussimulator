...
public class CliqueTransactionMessageHandlerSec extends Thread {
    ...
    public CliqueTransactionMessageHandlerSec(BlockingQueue<JSONObject> intransactionBlockingQueue,
