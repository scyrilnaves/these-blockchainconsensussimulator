...
public class CliqueTransactionMessageHandlerQuar extends Thread {
    ...
    public CliqueTransactionMessageHandlerQuar(BlockingQueue<JSONObject> intransactionBlockingQueue,
