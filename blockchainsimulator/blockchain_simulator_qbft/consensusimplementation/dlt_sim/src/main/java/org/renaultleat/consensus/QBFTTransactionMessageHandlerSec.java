...
public class QBFTTransactionMessageHandlerSec extends Thread {
    ...
    public QBFTTransactionMessageHandlerSec(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
            ...
            QBFTMessagePool pbftMessagePool, Synchronizer synchronizer) {
