...
public class QBFTTransactionMessageHandler extends Thread {
    ...
    public QBFTTransactionMessageHandler(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
