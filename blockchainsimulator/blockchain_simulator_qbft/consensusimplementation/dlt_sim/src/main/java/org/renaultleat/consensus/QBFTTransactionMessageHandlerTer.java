...
public class QBFTTransactionMessageHandlerTer extends Thread {
    ...
    public QBFTTransactionMessageHandlerTer(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
