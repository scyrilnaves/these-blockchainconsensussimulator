...
public class QBFTTransactionMessageHandlerSix extends Thread {
    ...
    public QBFTTransactionMessageHandlerSix(BlockingQueue<JSONObject> intransactionBlockingQueue,
