...
public class QBFTTransactionMessageHandlerQuar extends Thread {
    ...
    public QBFTTransactionMessageHandlerQuar(BlockingQueue<JSONObject> intransactionBlockingQueue,
