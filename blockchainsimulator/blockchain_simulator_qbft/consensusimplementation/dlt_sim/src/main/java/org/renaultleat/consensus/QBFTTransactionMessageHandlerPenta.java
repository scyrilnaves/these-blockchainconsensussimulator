...
public class QBFTTransactionMessageHandlerPenta extends Thread {
    ...
    public QBFTTransactionMessageHandlerPenta(BlockingQueue<JSONObject> intransactionBlockingQueue,
