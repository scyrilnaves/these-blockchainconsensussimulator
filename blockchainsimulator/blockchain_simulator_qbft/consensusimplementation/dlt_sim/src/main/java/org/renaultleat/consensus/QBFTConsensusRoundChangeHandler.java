 ...
 * 
 */
public class QBFTConsensusRoundChangeHandler extends AbstractScheduledService {
    ...
    public void task() {
        ...
        if (NodeProperty.isValidator()) {
            ...
            if (pendingblock != null) {
                ...
                Message roundchangemessage = this.qbftMessagePool.message("ROUNDCHANGE",
                        pendingblock,
    ...
    public QBFTConsensusRoundChangeHandler(
            NodeCommunicator nodeCommunicator, String currentuser, Synchronizer synchronizer, Blockchain blockChain,
            QBFTMessagePool qbftMessagePool, Wallet wallet, BlockPool blockPool) {
