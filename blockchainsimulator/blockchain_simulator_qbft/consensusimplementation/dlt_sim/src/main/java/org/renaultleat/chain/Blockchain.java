...
public class Blockchain {
    ...
    /**
     * Get the latest block hash + Round as QBFT is dependent on Rounds and get the
     * unicode value at position 2
     * Then get the modulo value with the total nodes
     * 
     * @return
     */
    // QBFT Changed to the validators and not total nodes
    ...
    public void addUpdatedBlock(Block block, BlockPool blockPool, QBFTMessagePool pbftMessagePool) {
