...
public class PBFTTransactionMessageHandlerQuar extends Thread {
    ...
    public PBFTTransactionMessageHandlerQuar(BlockingQueue<JSONObject> intransactionBlockingQueue,
            Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NodeCommunicatorQuar nodeCommunicator, String currentuser,
