...
public class PBFTTransactionMessageHandlerSec extends Thread {
    ...
    public PBFTTransactionMessageHandlerSec(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NodeCommunicatorSec nodeCommunicator, String currentuser,
