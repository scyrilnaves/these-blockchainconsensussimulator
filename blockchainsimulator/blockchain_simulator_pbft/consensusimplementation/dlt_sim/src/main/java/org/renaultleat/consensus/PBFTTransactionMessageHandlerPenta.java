...
public class PBFTTransactionMessageHandlerPenta extends Thread {
    ...
    public PBFTTransactionMessageHandlerPenta(BlockingQueue<JSONObject> intransactionBlockingQueue,
            Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NodeCommunicatorPenta nodeCommunicator, String currentuser,
