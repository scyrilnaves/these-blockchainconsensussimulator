...
public class QueueResource {
    ...
    volatile BlockingQueue<JSONObject> transactionBlockingQueueSix = new LinkedBlockingQueue<JSONObject>();
    ...
    public synchronized BlockingQueue<JSONObject> getTransactionBlockingQueueSix() {
        return this.transactionBlockingQueueSix;
    }
