...
public class PBFTTransactionMessageHandlerTer extends Thread {
    ...
    public PBFTTransactionMessageHandlerTer(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NodeCommunicatorTer nodeCommunicator, String currentuser,
