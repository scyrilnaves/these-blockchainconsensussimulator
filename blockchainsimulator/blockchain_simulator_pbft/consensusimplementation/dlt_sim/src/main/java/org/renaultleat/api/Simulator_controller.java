...
import org.renaultleat.consensus.PBFTTransactionMessageHandlerPenta;
import org.renaultleat.consensus.PBFTTransactionMessageHandlerQuar;
import org.renaultleat.consensus.PBFTTransactionMessageHandlerSec;
import org.renaultleat.consensus.PBFTTransactionMessageHandlerSix;
import org.renaultleat.consensus.PBFTTransactionMessageHandlerTer;
...
public class Simulator_controller {
        ...
        PBFTTransactionMessageHandlerSec pbftTransactionMessageHandlerSec;

        PBFTTransactionMessageHandlerTer pbftTransactionMessageHandlerTer;

        PBFTTransactionMessageHandlerQuar pbftTransactionMessageHandlerQuar;

        PBFTTransactionMessageHandlerPenta pbftTransactionMessageHandlerPenta;

        PBFTTransactionMessageHandlerSix pbftTransactionMessageHandlerSix;
        ...
        public String storeNodeProperty(@PathParam("value") String value) {
                ...
                this.blockchain = new Blockchain(validator);

                this.transactionPool = new TransactionPool();

                this.pbftMessagePool = new PBFTMessagePool();

                this.blockPool = new BlockPool();

                this.queueResource = new QueueResource();

                this.p2pserver = new P2PServer(this.blockchain, this.transactionPool, this.wallet, this.pbftMessagePool,
                                this.validator, this.blockPool,
                                this.queueResource);
        ...
        public String listentoPeers() {
                ...
                this.pbftTransactionMessageHandler = new PBFTTransactionMessageHandler(
                                this.queueResource.getTransactionBlockingQueue(), this.blockchain, this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicator, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandler.start();

                this.pbftTransactionMessageHandlerSec = new PBFTTransactionMessageHandlerSec(
                                this.queueResource.getTransactionBlockingQueueSec(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicatorSec, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandlerSec.start();

                this.pbftTransactionMessageHandlerTer = new PBFTTransactionMessageHandlerTer(
                                this.queueResource.getTransactionBlockingQueueTer(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicatorTer, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandlerTer.start();

                this.pbftTransactionMessageHandlerQuar = new PBFTTransactionMessageHandlerQuar(
                                this.queueResource.getTransactionBlockingQueueQuar(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicatorQuar, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandlerQuar.start();

                this.pbftTransactionMessageHandlerPenta = new PBFTTransactionMessageHandlerPenta(
                                this.queueResource.getTransactionBlockingQueuePenta(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicatorPenta, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandlerPenta.start();

                this.pbftTransactionMessageHandlerSix = new PBFTTransactionMessageHandlerSix(
                                this.queueResource.getTransactionBlockingQueueSix(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator,
                                this.p2pserver.nodeCommunicatorSix, this.p2pserver.currentuser, this.pbftMessagePool,
                                this.synchronizer);
                this.pbftTransactionMessageHandlerSix.start();

                this.pbftConsensusMessageHandler = new PBFTConsensusMessageHandler(
                ...
                this.pbftConsensusMessageHandler.start();
        ...
        public String startSimulation9(@PathParam("notxs") String notxs) {
                ...
                // TransactionBroadcaster transactionBroadcasterSec = new
                ...
                return gson.toJson("Simulation Started 9");
        }
        ...
        public String getMinApproval() {
                int minApprovals = pbftConsensusMessageHandler.getMinApprovals();
