...
public class PBFTTransactionMessageHandler extends Thread {
    ...
    public PBFTTransactionMessageHandler(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
