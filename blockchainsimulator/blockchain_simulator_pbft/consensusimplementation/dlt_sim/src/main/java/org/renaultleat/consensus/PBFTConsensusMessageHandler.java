...
public class PBFTConsensusMessageHandler extends Thread {
                            ...
                            if (messageType.equals("PRE-PREPARE")) {
                                ...
                                if (!this.pbftMessagePool.existingRoundChangeMessage(roundchangeMessage)
                                    ...
                                    if (this.pbftMessagePool.roundChangePool.get(blockhash)
                                            .size() >= this.minapprovals
                                            || this.pbftMessagePool.roundChangePool.get(blockhash)
                                                    .size() >= this.minapprovalsalt) {
    ...
    public PBFTConsensusMessageHandler(BlockingQueue<JSONObject> inMessageBlockingQueue, Blockchain blockChain,
