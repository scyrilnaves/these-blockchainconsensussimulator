...
consensus=PBFT
totaltxs=1500000
# max 70 above 70: Memory: 95% reserved 89% cores reserved
noofnodes=(25)
networktype=(mesh)
latency=(0)
blocksize=(2000)
  ...
  for nwtype in "${networktype[@]}"; do
    for nwlaten in "${latency[@]}"; do
      for blsize in "${blocksize[@]}"; do
        ...
        testtype="NoNode:"$noofnode";NwType:"$nwtype";BlockSize:"$blsize";NwLatency:"$nwlaten";NodeBehaviour:"$nodebehaviour";TotalTxs:"$totaltxs";Consensus:"$consensus";Iteration:"$iteration
