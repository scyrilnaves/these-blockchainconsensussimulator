...
public class P2PHandlerSec extends Thread {
    ...
    public IBFTMessagePool pbftMessagePool;
    ...
    public NodeCommunicatorSec nodeCommunicator;

    public QueueResource queueResource;

    public String currentuser;

    public P2PHandlerSec(Socket socket, Blockchain blockChain, TransactionPool transactionPool, Wallet wallet,
            IBFTMessagePool pbftMessagePool, Validator validator, NonValidator nonValidator, P2PServer p2pServer,
            NodeCommunicatorSec nodeCommunicator, String currrentuser, BlockPool blockPool, QueueResource queueResource)
            throws IOException {
    ...
    public void run() {
        ...
        // IBFTMessageHandler ibftMessageHandler = new
        // IBFTMessageHandler(this.blockchain, this.transactionPool,
                        ...
                        if (multithread) {
                            if (!messagevalidity.isEmpty() && !messagevalidity.isBlank()) {
                                ...
                                if (messageType.equals("TRANSACTION")) {
                                    this.queueResource.getTransactionBlockingQueueSec().put(jsonObject);
                                } else {
                          ...
                          // ibftMessageHandler.handleMessage(jsonObject);
