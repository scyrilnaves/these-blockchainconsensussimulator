...
public class IBFTTransactionMessageHandlerPenta extends Thread {
    ...
    public void broadCastPrePrepare(Block block, String message)
        ...
        this.nodeCommunicatorPenta.sendMessage(jsonObject.toString());
    }
    ...
    public IBFTTransactionMessageHandlerPenta(BlockingQueue<JSONObject> intransactionBlockingQueue,
