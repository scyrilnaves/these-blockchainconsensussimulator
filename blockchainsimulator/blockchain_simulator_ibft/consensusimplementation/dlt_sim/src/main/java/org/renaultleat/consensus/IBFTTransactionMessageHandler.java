...
public class IBFTTransactionMessageHandler extends Thread {
    ...
    public IBFTTransactionMessageHandler(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
