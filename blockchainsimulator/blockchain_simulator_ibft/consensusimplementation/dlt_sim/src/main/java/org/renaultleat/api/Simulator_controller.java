...
public class Simulator_controller {
        ...
        IBFTTransactionMessageHandlerSec ibftTransactionMessageHandlerSec;

        IBFTTransactionMessageHandlerTer ibftTransactionMessageHandlerTer;

        IBFTTransactionMessageHandlerQuar ibftTransactionMessageHandlerQuar;

        IBFTTransactionMessageHandlerPenta ibftTransactionMessageHandlerPenta;

        IBFTTransactionMessageHandlerSix ibftTransactionMessageHandlerSix;
        ...
        public String storeNodeProperty(@PathParam("value") String value) {
                ...
                this.ibftMessagePool = new IBFTMessagePool();

                this.blockPool = new BlockPool();

                this.queueResource = new QueueResource();

                this.p2pserver = new P2PServer(this.blockchain, this.transactionPool, this.wallet, this.ibftMessagePool,
        ...
        public String listentoPeers() {
                ...
                this.ibftTransactionMessageHandler = new IBFTTransactionMessageHandler(
                                this.queueResource.getTransactionBlockingQueue(), this.blockchain, this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicator, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandler.start();

                this.ibftTransactionMessageHandlerSec = new IBFTTransactionMessageHandlerSec(
                                this.queueResource.getTransactionBlockingQueueSec(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicatorSec, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandlerSec.start();

                this.ibftTransactionMessageHandlerTer = new IBFTTransactionMessageHandlerTer(
                                this.queueResource.getTransactionBlockingQueueTer(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicatorTer, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandlerTer.start();

                this.ibftTransactionMessageHandlerQuar = new IBFTTransactionMessageHandlerQuar(
                                this.queueResource.getTransactionBlockingQueueQuar(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicatorQuar, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandlerQuar.start();

                this.ibftTransactionMessageHandlerPenta = new IBFTTransactionMessageHandlerPenta(
                                this.queueResource.getTransactionBlockingQueuePenta(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicatorPenta, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandlerPenta.start();

                this.ibftTransactionMessageHandlerSix = new IBFTTransactionMessageHandlerSix(
                                this.queueResource.getTransactionBlockingQueueSix(), this.blockchain,
                                this.transactionPool,
                                this.blockPool,
                                this.wallet,
                                this.validator, this.nonValidator,
                                this.p2pserver.nodeCommunicatorSix, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer);
                this.ibftTransactionMessageHandlerSix.start();

                this.ibftConsensusRoundChangeHandler = new IBFTConsensusRoundChangeHandler(
                                this.p2pserver.nodeCommunicator,
                                this.p2pserver.currentuser, this.synchronizer, this.blockchain, this.ibftMessagePool,
                                this.wallet,
                                this.blockPool);

                this.ibftConsensusMessageHandler = new IBFTConsensusMessageHandler(
                                ...
                                this.p2pserver.nodeCommunicator, this.p2pserver.currentuser, this.ibftMessagePool,
                                this.synchronizer,
                                this.simulator_result, ibftConsensusRoundChangeHandler);
                this.ibftConsensusMessageHandler.start();

                // Start Round Change Handler
                this.ibftConsensusRoundChangeHandler.scheduleTimer();
        ...
        public String getMinApproval() {
                int minApprovals = ibftConsensusMessageHandler.getMinApprovals();
