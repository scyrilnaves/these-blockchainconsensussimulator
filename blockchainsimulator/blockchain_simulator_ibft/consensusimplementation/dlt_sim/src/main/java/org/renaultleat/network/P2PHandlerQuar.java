...
public class P2PHandlerQuar extends Thread {
    ...
    public NodeCommunicatorQuar nodeCommunicator;

    public QueueResource queueResource;

    public String currentuser;

    public P2PHandlerQuar(Socket socket, Blockchain blockChain, TransactionPool transactionPool, Wallet wallet,
            IBFTMessagePool pbftMessagePool, Validator validator, NonValidator nonValidator, P2PServer p2pServer,
            NodeCommunicatorQuar nodeCommunicator, String currrentuser, BlockPool blockPool,
                        ...
                        if (multithread) {
                            if (!messagevalidity.isEmpty() && !messagevalidity.isBlank()) {
                                ...
                                if (messageType.equals("TRANSACTION")) {
                                    this.queueResource.getTransactionBlockingQueueQuar().put(jsonObject);
                                } else {
