...
public class IBFTTransactionMessageHandlerSec extends Thread {
    ...
    public void broadCastPrePrepare(Block block, String message)
        ...
        this.nodeCommunicatorSec.sendMessage(jsonObject.toString());
    }
            ...
            if (!this.transactionBlockingQueue.isEmpty()) {
                ...
                try {
                    ...
                    if (!this.transactionPool.confirmedTransactionIds.contains(inputTransaction.getId())
                        ...
                        try {
                            this.nodeCommunicatorSec.broadCastTransaction(this.currentuser,
    ...
    public IBFTTransactionMessageHandlerSec(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NonValidator nonValidator,
            NodeCommunicatorSec nodeCommunicatorSec, String currentuser,
            IBFTMessagePool pbftMessagePool, Synchronizer synchronizer) {
