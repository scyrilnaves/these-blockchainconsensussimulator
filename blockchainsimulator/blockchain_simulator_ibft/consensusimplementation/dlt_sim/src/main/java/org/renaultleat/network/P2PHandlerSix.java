...
public class P2PHandlerSix extends Thread {
    ...
    public P2PHandlerSix(Socket socket, Blockchain blockChain, TransactionPool transactionPool, Wallet wallet,
            IBFTMessagePool pbftMessagePool, Validator validator, NonValidator nonValidator, P2PServer p2pServer,
            NodeCommunicatorSix nodeCommunicator, String currrentuser, BlockPool blockPool,
                        ...
                        if (multithread) {
                            if (!messagevalidity.isEmpty() && !messagevalidity.isBlank()) {
                                ...
                                if (messageType.equals("TRANSACTION")) {
                                    this.queueResource.getTransactionBlockingQueueSix().put(jsonObject);
                                } else {
