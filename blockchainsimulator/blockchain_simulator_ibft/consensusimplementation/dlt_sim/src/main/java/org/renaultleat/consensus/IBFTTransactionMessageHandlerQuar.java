...
public class IBFTTransactionMessageHandlerQuar extends Thread {
    ...
    public void broadCastPrePrepare(Block block, String message)
        ...
        this.nodeCommunicatorQuar.sendMessage(jsonObject.toString());
    }
            ...
            if (!this.transactionBlockingQueue.isEmpty()) {
                ...
                try {
                    ...
                    if (!this.transactionPool.confirmedTransactionIds.contains(inputTransaction.getId())
                        ...
                        try {
                            this.nodeCommunicatorQuar.broadCastTransaction(this.currentuser,
    ...
    public IBFTTransactionMessageHandlerQuar(BlockingQueue<JSONObject> intransactionBlockingQueue,
            Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NonValidator nonValidator,
            NodeCommunicatorQuar nodeCommunicatorQuar, String currentuser,
