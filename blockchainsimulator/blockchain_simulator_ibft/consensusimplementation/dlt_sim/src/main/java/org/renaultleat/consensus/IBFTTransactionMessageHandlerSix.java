...
public class IBFTTransactionMessageHandlerSix extends Thread {
    ...
    public void broadCastPrePrepare(Block block, String message)
        ...
        this.nodeCommunicatorSix.sendMessage(jsonObject.toString());
    }
            ...
            if (!this.transactionBlockingQueue.isEmpty()) {
                ...
                try {
                    ...
                    if (!this.transactionPool.confirmedTransactionIds.contains(inputTransaction.getId())
                        ...
                        try {
                            this.nodeCommunicatorSix.broadCastTransaction(this.currentuser,
    ...
    public IBFTTransactionMessageHandlerSix(BlockingQueue<JSONObject> intransactionBlockingQueue,
            Blockchain blockChain,
            TransactionPool transactionPool, BlockPool blockPool, Wallet wallet, Validator validator,
            NonValidator nonValidator,
            NodeCommunicatorSix nodeCommunicatorSix, String currentuser,
