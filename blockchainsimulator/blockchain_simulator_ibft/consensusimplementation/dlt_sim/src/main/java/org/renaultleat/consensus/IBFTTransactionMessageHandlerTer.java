...
public class IBFTTransactionMessageHandlerTer extends Thread {
    ...
    public IBFTTransactionMessageHandlerTer(BlockingQueue<JSONObject> intransactionBlockingQueue, Blockchain blockChain,
